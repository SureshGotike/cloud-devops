...
<head>
   <!-- <title>Welcome to ${productNameFull}</title>-->
        <title>Welcome to MeetIdentity</title>
    ...
    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
      <div class="welcome-header">
       ...
       <!-- <h1>Welcome to <strong>${productNameFull}</strong></h1>-->
            <h1 style="color:white">Welcome to <strong>MeetIdentity</strong></h1>
      </div>
      <div class="row">
          ...
          <div class="card-pf h-l">
            ...
            <div class="welcome-primary-link">
             ...
             <!-- <div class="description">
              ...
              <div class="description">
                Centrally manage all aspects of the MeetIdentity IAM server
              </div>    
            </div>
          </div>
        </div>
